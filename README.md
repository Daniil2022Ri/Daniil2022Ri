...
<img src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExOGV2ZW8zNnh2anMxM2Q3djFzdzg5MTl1cmZ6OTJ3OHluaW5heWI3MSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/SiLUI6AdZWNNR34m1K/giphy.gif" width="100%" alt="Blade Runner Rain" />
...
🔥 **Backend:** Java 8-21, Spring Boot/Security/Cloud/AI/Batch/MVC, Microservices, DDD, CQRS, Event-Driven

🎨 **Frontend:** React 18, Vue 3, Next.js, TypeScript, Tailwind CSS

🗄️ **Базы данных:** PostgreSQL, MySQL, Oracle DB, Redis, Elasticsearch, MongoDB

📨 **Messaging:** Apache Kafka, RabbitMQ, gRPC, REST API, Apache Camel
...
|--------|------|----------|
| [PaymentService](https://github.com/Daniil2022Ri/PaymentService) | Java 21, Spring Boot, Kafka, PostgreSQL | Микросервис обработки платежей |
| [AIAssistantBackend](https://github.com/Daniil2022Ri/AIAssistantBackend) | Java 21, WebFlux, OpenAI, Redis | Реактивный бэкенд AI-ассистента |
| [Bank_DDD_Antifraund](https://github.com/Daniil2022Ri/Bank_DDD_Antifraund) | Java 17, Spring Cloud, DDD, CQRS | Микросервисная архитектура банка |
| [SpringSercutiry_V2](https://github.com/Daniil2022Ri/SpringSercutiry_V2) | Java 17, Spring Security, JWT | Базовая демонстрация Security |
| [MVC_Hibernate](https://github.com/Daniil2022Ri/MVC_Hibernate) | Java 11, Hibernate, PostgreSQL | Базовый проект Hibernate |
| [PP_2_2_2_spring-mvc](https://github.com/Daniil2022Ri/PP_2_2_2_spring-mvc) | Java 11, Spring MVC, Thymeleaf | Базовый проект Spring MVC |
